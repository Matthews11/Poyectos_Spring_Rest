package sv.edu.udb.www.view.xlsx;
...
public class FacturaXlsxView extends AbstractXlsxView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		Factura factura = (Factura) model.get("factura");//Se inyecta factura mediante el objeto model 	
		Sheet sheet = workbook.createSheet("Factura");//mediante el workbook se crea la plantilla
		
		MessageSourceAccessor mensajes =  getMessageSourceAccessor();
		
		//Creacion de la plantilla columnas y filas
		...
		//Inyectar los datos de la factura a mostrar
